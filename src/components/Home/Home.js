      ...
      <div className='Home-wrapper'>
        <div style={{ paddingBottom: '40px', height: 'fit-content' }}>
          ...
          <div style={{ marginTop: '40px' }}>
            ...
            HTML5, CSS, SASS, Tailwind and Bootstrap. I am a Software Engineer currently
            working at Concept Dash. I have also worked for popular fintech
          ...
          <div style={{ marginTop: '40px' }}>
            ...
            of the team. In 3+ years, I have led big tasks and even led and
